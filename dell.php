...
$query = mysqli_query($con, "SELECT * FROM products WHERE pid='4'");
                    ...
                    <div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?php echo $img1 ?>" class="d-block" width="495" height="525">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo $img2 ?>" class="d-block" width="495" height="525">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo $img3 ?>" class="d-block" width="495" height="525">
                            </div>
