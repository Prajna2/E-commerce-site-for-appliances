...
$query = mysqli_query($con, "SELECT * FROM products WHERE pid='10'");
		...
		<div class="container">
			<div class="row">
					...
					<div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="<?php echo $img1 ?>" class="d-block" width="500" height="550">
							</div>
				...
				<div class="col-md-7">
					...
					<p><b>Shipper Details: </b> ID:<?php echo $shipperid ?> <b> Phone no : <?php echo $shipperphone ?></p>
