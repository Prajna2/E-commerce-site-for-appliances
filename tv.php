...
$query = mysqli_query($con, "SELECT * FROM products WHERE pid='14'");
		...
		<div class="container">
			<div class="row">
					...
					<div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img src="<?php echo $img2 ?>" class="d-block" width="450" height="525">
							</div>
							<div class="carousel-item">
								<img src="<?php echo $img3 ?>" class="d-block" width="450" height="525">
							</div>
				...
				<div class="col-md-7">
					...
					<strike>
						<p class="price">Rs 1,19,600</p>
					</strike><b>10% Discount</b>
					<!----Strike and discount------->
