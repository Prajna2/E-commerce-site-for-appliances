...
$query = mysqli_query($con, "SELECT * FROM products WHERE pid='2'");
		...
		<div class="container">
			<div class="row">
					...
					<div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img src="<?php echo $img2 ?>" class="d-block" width="470" height="525">
							</div>
							<div class="carousel-item">
				...
				<div class="col-md-7">
					...
					<p><b>Shipper Details:vID:<?php echo $shipperid ?> <b> Phone no : <?php echo $shipperphone ?></p>
