...
$query = mysqli_query($con, "SELECT * FROM products WHERE pid='3'");
...
<body style="background-color: 		#F0F8FF;">
		...
		<div class="container">
			<div class="row">
					...
					<div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="<?php echo $img1 ?>" class="d-block" width="460" height="525">
							</div>
							<div class="carousel-item">
								<img src="<?php echo $img2 ?>" class="d-block " width="460" height="525">
							</div>
							<div class="carousel-item">
								<img src="<?php echo $img3 ?>" class="d-block " width="460" height="525">
							</div>
				...
				<div class="col-md-7">
					...
					<h2 style="color:black;"><b><?php echo $name ?></b></h2>
					...
					<p><b>Condition: </b><?php echo $cond ?></p>
					<p><b>Brand: </b><?php echo $brand ?></p>
					<p><b>Shipper Details: </b> ID: <?php echo $shipperid ?> <b> Phone no</b>: <?php echo $shipperphone ?></p>
	...
	<section class="product-description">
		<div class="container">
			<h6 style="font-weight: 900;font-size: larger;"><b>Product Description</b></h6>
			<p style="color:black;font-size: medium;"><?php echo $description ?></p><br>
			<hr>
		</div>
	</section>
